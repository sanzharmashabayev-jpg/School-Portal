        ...
        <Card>
          <div className="p-8">
            <div className="flex flex-col items-center">
              <div className="h-28 w-28 rounded-full bg-gradient-to-br from-green-700 to-green-900 flex items-center justify-center shadow-xl">
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 w-full">
                ...
                <div className="text-center p-4 rounded-xl bg-gradient-to-br from-green-50 to-green-100">
                  ...
                  <span className="block text-xs text-green-600 mt-1">Идеи</span>
                </div>
              </div>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mt-4 space-y-4">
              <div className="flex items-center p-3 rounded-xl bg-gradient-to-br from-green-50 to-green-100">
                <div className="p-2 rounded-lg bg-white shadow-sm">
                  <MailIcon className="h-5 w-5 text-green-700" />
                </div>
